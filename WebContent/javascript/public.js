	...
	layer.open({
	  ...
	  content: '<div class="pl-20 pr-20">'
		  +'<table class="table table-bordered table-striped mt-10">'
		  	+'<tr>'
		  		+'<td><img src="images/wechar.png" style="width:auto;max-width:100%;height:500px;"/></td>'
		  		+'<td><img src="images/alipay.jpg" style="width:auto;max-width:100%;height:500px;"/></td>'
		  	+'</tr>'
		  	+'<tr class="cen">'
